...
app = Flask(__name__)
#app.debug = True
file_url_base = "./website/app/static/resources/documents/"
...
def search(result = None):
	...
	#dic['test'] = keywords
	#return jsonify(dic)
	book = xlrd.open_workbook('./website/app/static/resources/info.xls')
	sheet = book.sheet_by_index(0)
	file = open('./website/app/static/resources/index.txt','r')
	while True:
		line = file.readline()
		#print line
		if not line:
	...
	for result in results:
		...
		summary_start_pos = content.find(keywords[0])
